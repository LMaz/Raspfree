...
<html>
    <head>
        <title>RaspFree Editar imagen</title>
        ...
        <div class="container MargenSup60">
            <div class="row well  well-sm">
                ...
                <div class ="titulo row">
                    ...
                    <h1 class="col-md-4 col-sm-4">Editar Imagen</h1>
                ...
                <?php
                    ...
                    <?php } 
                ?>
                <form autocomplete="off" <?php echo "action='validarEditarImagen.php?id=$id' "; ?> enctype="multipart/form-data" method="post">

                    <div class="form-group">
                        <h3>Título: </h3>
                        <input type="text" class="form-control" id="titulo" name="titulo" value="<?php echo $gal->tittle ?>" required="">
                    </div>
                    <div class="form-group">
                        <h3>Imagen principal:</h3>
                        <input type="file" class="form-control-file"  id="imagen" name="imagen">
                        <small id="fileHelp" class="form-text text-muted">Imagen actual:</small>
                        <?php  echo '<img class="img-responsive imgTut" src="data:image/jpeg;base64,'.base64_encode($gal->image).'"/>'; ?>
