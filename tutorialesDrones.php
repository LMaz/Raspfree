...
<html lang="es"> 
    <head>
        ...
        <title>RaspFree Tutoriales Drones</title>
            ...
            <div class="row well  well-sm">
                ...
                <div class="hidden-xs col-sm-12 col-md-12 col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Tutoriales Drones</li>
                    </ol>
                </div>
               ...
               <!--  ************************************* Mostrar Tutoriales ********************************************** -->
                ...
                if ($num_total_registros > 0) {
                    ...
                    $consult2 = getTutorialesPagDron($offset, $rowsPerPage);
                	...
                	<div class="MargenSuperior40">
                    	<div class="row col-md-offset-1">
	                        <div class=" col-md-4">
	                            <?php  echo '<img class="imgTuto img-responsive" src="data:image/jpeg;base64,'.base64_encode($img).'"/>'; ?>
	                        </div>
                                ...
                                <a class=" leerMas pull-right" <?php echo "href='tutorial.php?tut=$id&active=tutorial'"; ?>>Leer más...</a>
