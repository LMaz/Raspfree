...
<html lang="es"> 
    <head>
        ...
        <title>RaspFree Eventos Pasados</title>
        ...
        <div class="container MargenSup60">
            ...
            <div class="row well  well-sm">
                ...
                <div class="hidden-xs col-sm-12 col-md-12 col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Eventos Pasados</li>
                    </ol>
                </div>
                ...
                <?php
                    ...
                    if ($num_total_registros > 0) {
                        ...
                        $consult2 = getEventoPasadoPag($offset, $rowsPerPage);
                                        ...
                                        <div class="eventos-proximos-justify eventos-no-padding-derecha col-md-6">
                                            ...
                                            <!--Botón derecho-->
                                                <?php
                                                    $_SESSION['evento'] = $id;
                                                ?>
                                                <p class="eventos-proximos-right eventos-proximos-button eventos-proximos-white eventos-proximos-border">Participaron <span class="eventos-proximos-tag eventos-proximos-border eventos-proximos-white"> <?php echo numeroParticipantes($id); ?></p>
            ...
            <?php
	            if ($num_total_registros != null) {
	                if ($total_paginas > 1) {
	                    echo '<div class="paginateEventPas">';
